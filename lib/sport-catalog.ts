...
export const sportCatalog: SportCategory[] = [
  { id: "featured", label: "Featured", leagues: ["NFL", "NBA", "MLB", "NHL", "WNBA", "UFC", "PGA"] },
  ...
  { id: "soccer", label: "Soccer", leagues: ["MLS", "EPL", "UCL", "UEL", "LALIGA", "SERIE_A", "BUNDESLIGA", "LIGUE_1", "LIGA_MX", "NWSL", "FIFA"] },
